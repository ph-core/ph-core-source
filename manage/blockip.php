...
class Blockip extends \Controller\Make_Controller{

    public function _init(){
        $this->layout()->mng_head();
        $this->_func();
        $this->_make();
        $this->load_tpl(PH_MANAGE_PATH.'/html/blockip.tpl.php');
    ...
    public function form(){
        ...
        $form->set('type','html');
        $form->set('action',PH_MANAGE_DIR.'/blockip.sbm.php');
        $form->run();
    }
    ...
    public function _make(){
        ...
        $sql->query(
            $sql->scheme->blocked('sort:blockip'),''
        );
        ...
        $sql->query(
            $paging->paging_query(
                $sql->scheme->blocked('select:blockips'),''
            ),''
        );
